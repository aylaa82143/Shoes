...
# Hardcoded subcategory URLs for Men Footwear Group 2 (URLs 9–16)
SUBCATEGORY_URLS = [
      "https://www.boutiqaat.com/ar-kw/men/footwear/insoles-1/l/",
    "https://www.boutiqaat.com/ar-kw/men/footwear/sports-shoes/l/",
    "https://www.boutiqaat.com/ar-kw/men/footwear/sandals/l/",
    "https://www.boutiqaat.com/ar-kw/men/footwear/boots/l/",
    "https://www.boutiqaat.com/ar-kw/men/footwear/slides-flip-flops/l/",
    "https://www.boutiqaat.com/ar-kw/men/footwear/loafers-moccasins/l/",
    "https://www.boutiqaat.com/ar-kw/men/footwear/slip-ons/l/",
    "https://www.boutiqaat.com/ar-kw/men/footwear/lace-ups/l/",
]
...
class BoutiqaatDataPipeline:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/footwear/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        try:
            ...
            s3_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/men/footwear/excel-files"
            )
